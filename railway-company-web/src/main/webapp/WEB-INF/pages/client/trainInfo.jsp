            ...
            <div class="wide-form-box">
                ...
                <table class="simple-little-table" cellspacing='0'>
                    <tr>
                        ...
                        <td><spring:message code="tickets.free.count.label"/></td>
                        <td><spring:message code="price.label"/></td>
                    ...
                    <c:forEach var="route" items="${infoTrain.routes}">
                        <tr>
                            ...
                            <td>
                                ${infoTrain.seats - fn:length(route.tickets)}
                            </td>
                            <td>
                                ${route.cost}
                            </td>
                            <td>
                                <form action="<c:url value='/client/buyTicket'/>" method="POST">
                                    <input type="hidden" name="trainId" value="${train.id}">
                                    <input type="hidden" name="fromStation" value="${route.departureStation}">
                                    <input type="hidden" name="toStation" value="${route.arrivalStation}">
                                    <input class="simple-btn" type="submit"
                                           value="<spring:message code="ticket.buy.label"/>">
                                </form>
                            </td>
                        </tr>
                    </c:forEach>
